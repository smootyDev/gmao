-- Updates the standard CMMS descriptions for the asset type catalog.
...
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM schema_migrations WHERE version = '004_asset_type_descriptions') THEN
        ...
        INSERT INTO schema_migrations (version) VALUES ('004_asset_type_descriptions');
    END IF;
END $$;
